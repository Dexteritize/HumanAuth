...
class TestAuthPageComponent(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.component_path = Path(__file__).parent.parent.parent / 'HumanAuth-FullStack' / 'frontend' / 'src' / 'app' / 'auth-page'
...
class TestAuthPageTemplate(unittest.TestCase):
    ...
    def setUp(self):
        """Set up test fixtures"""
        self.html_file = Path(__file__).parent.parent.parent / 'HumanAuth-FullStack' / 'frontend' / 'src' / 'app' / 'auth-page' / 'auth-page.component.html'
...
class TestAuthPageStyles(unittest.TestCase):
    ...
    def setUp(self):
        """Set up test fixtures"""
        self.scss_file = Path(__file__).parent.parent.parent / 'HumanAuth-FullStack' / 'frontend' / 'src' / 'app' / 'auth-page' / 'auth-page.component.scss'
