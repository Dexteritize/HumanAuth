...
def start_backend():
    ...
    backend_dir = Path('/Users/jasondank/PycharmProjects/HumanAuth/humanauth-render')
...
def verify_frontend_changes():
    ...
    component_file = Path('/Users/jasondank/PycharmProjects/HumanAuth/humanauth-render/frontend/src/app/auth-page/auth-page.component.ts')
